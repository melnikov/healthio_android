...
public class DateComponentIntentTreatment extends Activity {
	private TreatmentsLauncher parentActivity;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (idObjectTimes>0) {
			...
			if (objectRepeatLength>0) {
				...
				TreatmentsItem element=(TreatmentsItem) twotabObject.get(idObjectTimes);
	...
	public void submit(View target) {
		TreatmentAddForm.transitionTwotab=false;
		TreatmentEditObj.transitionTwotab=false;
